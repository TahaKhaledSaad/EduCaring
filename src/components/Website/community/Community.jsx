      ...
      {chat ? (
        <div className="commuinty d-flex gap-3 p-3">
              ...
              `}
                ...
                >
                  ...
                  <div className="text">
                    {/* <h6>
                  {" "}
                  {item.eventData?.name.split(" ").slice(0, 3).join(" ")}{" "}
                  {item.eventData?.name.split(" ").length > 3 ? "..." : ""}
                </h6> */}
                    <h6>
                      {item.eventData ? (
                        <>
          ...
          {showChatContent && selectedChat && (
            <div
              className={`chat-content ${showChatContent ? "show" : "hide"}`}
            >
        ...
        >
          ...
          <p className="fs-4 fw-bold" style={{ color: "#bdbdbd" }}>
            {i18n.language === "en" ? "NO Communities" : "لا يوجد مجتمعات "}
          </p>
        </div>
      )}
    </>
